...
const EditProductForm = ({ setProductName,
    ...
    return (
        <div>
            <h1 className="text-2xl py-5">Update the Product</h1>
            <form onSubmit={handleSubmit} className="w-[300px]">
                <div className="form-group">
                    ...
                    <input type="text" className="w-full p-2" id="productName" placeholder="Enter name of the product" onChange={(e) => setProductName(e.target.value)} />
                </div>
                <div className="form-group">
                    <span className="flex"><label htmlFor="productOwnerName" className="text-xl">Product Owner</label><p className="text-red-600">*</p></span>
                    <input type="text" className="w-full p-2" id="productOwnerName" placeholder="Enter the product Owner" onChange={(e) => setProductOwnerName(e.target.value)} />
                </div>
                <div className="form-group">
                    <span className="flex"><label htmlFor="Developers" className="text-xl">Developers</label><p className="text-red-600">*</p></span>
                    <input type="text" className="w-full p-2" id="Developers" placeholder="Enter name of the Developers" onChange={handleChange} />
                </div>
                <div className="form-group">
                    ...
                    <input type="text" className="w-full p-2" id="scrumMasterName" placeholder="Enter the name of Scrum Master" onChange={(e) => setScrumMasterName(e.target.value)} />
                </div>
                <div className="form-group">
